...
/**
 * ============================================================================
 * AUTH ENFORCEMENT IN APP ROUTES
 * ============================================================================
 * 
 * This demonstrates how authentication is enforced in protected app routes.
 * 
 * authenticate.admin(request) does the following:
 * 1. Extracts session from request (cookies, headers)
 * 2. Validates session exists and is valid
 * 3. Returns { admin, session } if authenticated
 * 4. Redirects to login if not authenticated
 * 
 * This is all you need to protect a route - one line of code!
 */
export const loader = async ({ request }) => {
  // This single line enforces authentication:
  // - If authenticated: Returns { admin, session }
